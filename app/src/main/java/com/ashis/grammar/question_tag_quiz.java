...
public class question_tag_quiz extends AppCompatActivity {
    private TextView textViewQuestion;
    private TextView textViewQuestionCount;
    private TextView answer;
    private TextView answer_below;
    private Button show_answer;
    private List<tag_Question> questionList;
    private int questionCounter;
    private int questionCountTotal;
    private tag_Question currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tag_QuizDbHelper dbHelper1=new tag_QuizDbHelper(this);
